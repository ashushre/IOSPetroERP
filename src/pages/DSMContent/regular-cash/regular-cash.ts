...
// }
      console.log(this.dsm.balanceAmount,this.dsm.totalCashPayable,totalAmount,this.dsm.totalBalance);
    ...
    //  this.dsm.balanceAmount=  Math.round(this.dsm.balanceAmount);round off
  ...
  showTotalSales() {
    ...
    //  this.dsm.balanceAmount=  Math.round(this.dsm.balanceAmount); round off
      ...
      // this.dsm.total=Math.round(this.dsm.total); round off
      // this.dsm.credit=Math.round(this.dsm.credit);round off
      // this.dsm.totalTesting=Math.round(this.dsm.totalTesting);round off
